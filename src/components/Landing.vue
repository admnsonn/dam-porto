<template>
	<section id="home" class="w-full flex justify-between flex-wrap items-center pt-16 md:pt-24 px-8 md:px-24 py-6 lg:min-h-screen bg-gradient-to-l from-gray-100 to-indigo-100 dark:from-[#18181b] dark:to-[#111827]">
		<div class="dark:text-[#f8fafc] text-[#09090b] animate__animated animate__zoomInDown  md:w-6/12 mb-16 md:mb-0">
			...
			<a href="https://drive.google.com/file/d/1TQXrvLs2SN69OfImU2cchyL0KTMsBRoM/view?usp=sharing" class="inline-block bg-gradient-to-r from-[#bae6fd] to-[#38bdf8] dark:from-[#0284c7] dark:to-[#0c4a6e] text-[#374151] dark:text-[#f8fafc] font-medium text-base px-5 py-3 rounded-lg font-semibold">
				<i class="fa fa-download"></i>
				See My CV
			</a>		
		</div>
		<div class="animate__animated animate__zoomInDown md:w-5/12 mt-12 mb-6 bg-gradient-to-r from-[#bae6fd] dark:from-[#0284c7] to-[#38bdf8] dark:to-[#0c4a6e] shadow rounded-full md:mb-0">
