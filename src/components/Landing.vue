<template>
	<section id="home" class="w-full flex justify-between flex-wrap items-center pt-16 md:pt-24 px-8 md:px-24 py-6 lg:min-h-screen bg-gradient-to-l from-indigo-100 to-gray-100 dark:from-[#18181b] dark:to-[#18181b]">
		<div class="dark:text-gray-300 animate__animated animate__zoomInDown  md:w-6/12 mb-16 md:mb-0">
			...
			<a href="https://drive.google.com/file/d/1Ox4O5OL3Puv_YgyOZa9wtkd9hSIZSI6W/view?usp=sharing" class="inline-block bg-gradient-to-r from-[#0284c7] to-[#38bdf8] text-gray-100 font-medium text-base px-5 py-3 rounded-lg">
		...
		<div class="w-full grid place-items-center py-5 md:py-10">
			<div class="text-3xl flex gap-5">
				<a href="https://instagram.com/admnsonn/?utm_medium=copy_link" taget="_blank"><i class="fab fa-instagram text-pink-800 dark:text-[#9ca3af]"></i></a>
				<a href="https://github.com/admnsonn" taget="_blank"><i class="fab fa-github text-gray-800 dark:text-[#9ca3af]"></i></a>
				<a href="https://linkedin.com/in/damfirdaus/" taget="_blank"><i class="fab fa-linkedin text-[#075985] dark:text-[#9ca3af]"></i></a>
				<a href="https://wa.me/6282128689209" taget="_blank"><i class="fab fa-whatsapp text-[#166534] dark:text-[#9ca3af]"></i></a>
			</div>
		</div>
	</section>
</template>
